...
var DynamicCarousel = (function () {
  ...
  */
  ...
  var initializeCarousel = function initializeCarousel(bz, config, cb, onClickThrough) {
    ...
    page.style.userSelect = "none"; // console.log(`config data: ${config}, bz data: ${bz}, cb data is: ${cb},clickthrough data: ${onClickThrough}`);
    // console.log(` config data ${config.feedDataElement}`);

    console.log(" find data or raw json".concat(JSON.parse(bz.Creative.getElementByName(config.feedDataElement).el)));
    ...
    function initialize() {
      ...
      (carouselContainer ? carouselContainer.el : page).appendChild(createSwiperCarouselDOM(config, products, onClickThrough));
